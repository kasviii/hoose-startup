...
export default function Contact() {
  ...
  return (
    <div style={{backgroundColor: "#0b7d40"}}>
      ...
      {/* Hero */}
      <section style={{position: "relative", overflow: "hidden", background: "linear-gradient(160deg, #085c30 0%, #0b7d40 50%, #0d9651 100%)", padding: isMobile ? "100px 0 60px" : "140px 0 80px"}}>
          ...
          <div style={{display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? "40px" : "80px", alignItems: "center"}}>
            ...
            <div>
              ...
              <motion.h1
                ...
                style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "38px" : "54px", fontWeight: "900", color: "white", letterSpacing: isMobile ? "-1px" : "-2px", lineHeight: "1.05", marginBottom: "20px"}}
              >
                Let's grow your<br />
                <span style={{background: "linear-gradient(90deg, white 0%, rgba(255,255,255,0.7) 30%, white 60%)", backgroundSize: "200% auto", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", animation: "shimmer 4s linear infinite"}}>food brand</span><br />
                together
              </motion.h1>
              ...
              >
                {reasons.map(function(r) {
                  return (
                    <motion.div
                      key={r[1]}
                      style={{display: "flex", alignItems: "center", gap: "10px", backgroundColor: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "14px", padding: isMobile ? "10px 12px" : "12px 16px"}}
                      whileHover={{ backgroundColor: "rgba(0,0,0,0.3)", borderColor: "rgba(255,255,255,0.25)", x: 4 }}
                      transition={{ type: "spring", stiffness: 300, damping: 25 }}
                    >
                      <span style={{fontSize: isMobile ? "16px" : "20px"}}>{r[0]}</span>
                      <div>
                        <div style={{fontSize: isMobile ? "12px" : "13px", fontWeight: "700", color: "white", fontFamily: "Syne, sans-serif"}}>{r[1]}</div>
                        {!isMobile && <div style={{fontSize: "11px", color: "rgba(255,255,255,0.5)", marginTop: "1px"}}>{r[2]}</div>}
                      </div>
                    </motion.div>
                  );
                })}
      ...
      {/* Form section */}
      <section style={{backgroundColor: "#0b7d40", padding: isMobile ? "48px 0 80px" : "80px 0 120px"}}>
        <div style={{maxWidth: "1100px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px"}}>
          <div style={{display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? "40px" : "64px", alignItems: "start"}}>
            ...
            >
              <h2 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "26px" : "36px", fontWeight: "800", color: "white", marginBottom: "10px", letterSpacing: "-0.5px"}}>
                Follow our journey
              </h2>
              <p style={{fontSize: "15px", color: "rgba(255,255,255,0.6)", marginBottom: "24px", lineHeight: "1.7"}}>
              ...
              <div style={{display: "flex", gap: "10px", marginBottom: "36px", flexWrap: "wrap"}}>
                {[["📸", "Instagram"], ["👥", "Facebook"], ["💼", "LinkedIn"]].map(function(s) {
                  return (
                    <motion.div
                      key={s[1]}
                      style={{display: "flex", alignItems: "center", gap: "6px", backgroundColor: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "10px", padding: "9px 14px", cursor: "pointer", fontSize: "13px", fontWeight: "600", color: "rgba(255,255,255,0.8)"}}
              ...
              {isMobile && (
                <div style={{display: "flex", flexDirection: "column", gap: "10px", marginBottom: "32px"}}>
                  {contactItems.map(function(item) {
                    return (
                      <div key={item.label} style={{display: "flex", alignItems: "center", gap: "14px", padding: "14px 16px", backgroundColor: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "14px"}}>
                        <div style={{width: "38px", height: "38px", backgroundColor: "rgba(255,255,255,0.08)", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px", flexShrink: 0}}>
                          {item.icon}
                        </div>
                        <div>
                          <div style={{fontSize: "10px", color: "#86efac", marginBottom: "2px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "600"}}>{item.label}</div>
              ...
              <div style={{background: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "20px", padding: "24px 28px"}}>
                <div style={{fontSize: "24px", color: "rgba(255,255,255,0.3)", fontFamily: "Georgia, serif", lineHeight: 1, marginBottom: "10px"}}>"</div>
                <p style={{fontSize: isMobile ? "14px" : "15px", color: "rgba(255,255,255,0.8)", margin: 0, lineHeight: "1.8", fontStyle: "italic"}}>
                  We built Hoose because we believe every street food vendor deserves the same tools as a big restaurant chain.
                </p>
                <div style={{marginTop: "14px", fontSize: "13px", color: "#86efac", fontWeight: "600"}}>— Divyanshu & Dhananjay, Co-Founders</div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
              style={{backgroundColor: "rgba(0,0,0,0.22)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "28px", padding: isMobile ? "28px 24px" : "44px"}}
            >
              {sent ? (
                <div style={{textAlign: "center", padding: "48px 0"}}>
                  ...
                  >🎉</motion.div>
                  <h3 style={{fontFamily: "Syne, sans-serif", fontSize: "26px", fontWeight: "800", color: "white", marginBottom: "10px"}}>Message Sent!</h3>
                  <p style={{color: "rgba(255,255,255,0.6)", fontSize: "15px", lineHeight: "1.7"}}>We'll get back to you within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} style={{display: "flex", flexDirection: "column", gap: "14px"}}>
                  <h3 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "22px" : "26px", fontWeight: "800", color: "white", marginBottom: "6px"}}>Send us a message</h3>
                  ...
                  <textarea style={Object.assign({}, getInputStyle("message"), {height: "120px", resize: "none"})} name="message" placeholder="Tell us about your food business..." value={form.message} onChange={handleChange} required onFocus={function() { setFocused("message"); }} onBlur={function() { setFocused(""); }} />
                  <motion.button
                    type="submit"
                    style={{backgroundColor: "white", color: "#0b7d40", padding: "15px", borderRadius: "14px", fontWeight: "700", fontSize: "15px", border: "none", cursor: "pointer", fontFamily: "Syne, sans-serif"}}
