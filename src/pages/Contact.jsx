    ...
    <div style={{backgroundColor: "#0b7d40"}}>
      ...
      <section style={{position: "relative", overflow: "hidden", padding: "160px 0 80px", background: "linear-gradient(160deg, #085c30 0%, #0b7d40 50%, #0d9651 100%)"}}>
        <div style={{position: "absolute", inset: 0}}>
          <div style={{position: "absolute", width: "500px", height: "500px", borderRadius: "50%", background: "radial-gradient(circle, rgba(255,255,255,0.06) 0%, transparent 70%)", top: "-100px", left: "-100px"}} />
      ...
      <section style={{backgroundColor: "#0b7d40", padding: "80px 0 120px"}}>
        <div style={{maxWidth: "1100px", margin: "0 auto", padding: "0 48px"}}>
          <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "start"}}>
            ...
            >
              <h2 style={{fontFamily: "Syne, sans-serif", fontSize: "32px", fontWeight: "800", color: "white", marginBottom: "32px", letterSpacing: "-0.5px"}}>
                Contact Information
              </h2>
              <div style={{display: "flex", flexDirection: "column", gap: "14px", marginBottom: "40px"}}>
                {contactItems.map(function(item) {
                  return (
                    <motion.div
                      key={item.label}
                      style={{display: "flex", alignItems: "center", gap: "16px", padding: "20px 24px", backgroundColor: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "16px"}}
                      whileHover={{ backgroundColor: "rgba(0,0,0,0.3)", borderColor: "rgba(255,255,255,0.25)" }}
                      transition={{ duration: 0.2 }}
                    >
                      <div style={{width: "48px", height: "48px", backgroundColor: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px", flexShrink: 0}}>
                        {item.icon}
                      </div>
                      <div>
                        <div style={{fontSize: "11px", color: "#86efac", marginBottom: "4px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "600"}}>{item.label}</div>
              ...
              <div style={{background: "rgba(0,0,0,0.22)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "24px", padding: "32px", position: "relative", overflow: "hidden"}}>
                <div style={{position: "absolute", top: "-30px", right: "-30px", width: "120px", height: "120px", borderRadius: "50%", background: "radial-gradient(circle, rgba(255,255,255,0.06) 0%, transparent 70%)"}} />
                ...
                <div style={{display: "flex", gap: "10px"}}>
                  {[["📸", "Instagram"], ["👥", "Facebook"], ["💼", "LinkedIn"]].map(function(s) {
                    return (
                      <motion.div
                        key={s[1]}
                        style={{display: "flex", alignItems: "center", gap: "6px", backgroundColor: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "10px", padding: "8px 14px", cursor: "pointer", fontSize: "13px", fontWeight: "600", color: "rgba(255,255,255,0.8)"}}
