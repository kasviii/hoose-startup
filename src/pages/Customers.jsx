...
export default function Customers() {
  ...
  return (
    <div style={{backgroundColor: "#0b7d40"}}>
      ...
      {/* Hero */}
      <section style={{position: "relative", overflow: "hidden", padding: "140px 0 0", background: "linear-gradient(160deg, #085c30 0%, #0b7d40 50%, #0d9651 100%)"}}>
        ...
        <div style={{maxWidth: "1280px", margin: "0 auto", padding: "0 48px", position: "relative", zIndex: 1}}>
          <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center", paddingBottom: "64px"}}>
            ...
            <div>
              ...
              >
                <motion.div
                  ...
                  style={{backgroundColor: "white", color: "#0b7d40", padding: "13px 32px", borderRadius: "999px", fontWeight: "700", fontSize: "14px", cursor: "pointer", fontFamily: "Syne, sans-serif"}}
                ...
                <motion.div
                  ...
                  style={{border: "2px solid rgba(255,255,255,0.35)", color: "white", padding: "13px 32px", borderRadius: "999px", fontWeight: "500", fontSize: "14px", cursor: "pointer"}}
            ...
            {/* Right — stacked mini plan cards */}
            <div style={{position: "relative", height: "380px"}}>
              {[
                { name: "Starter", price: "₹499", color: "rgba(0,0,0,0.3)", top: "0px", left: "40px", rotate: "-3deg", zIndex: 1 },
                { name: "Growth ★", price: "₹1499", color: "rgba(0,0,0,0.45)", top: "60px", left: "20px", rotate: "0deg", zIndex: 2 },
                { name: "Pro", price: "₹2499", color: "rgba(0,0,0,0.3)", top: "30px", left: "0px", rotate: "3deg", zIndex: 1 },
              ].map(function(card, i) {
                return (
                  <motion.div
                    key={card.name}
                      ...
                      {["Profile", "Dashboard", "Analytics"].map(function(f) {
                        return (
                          <div key={f} style={{display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "rgba(255,255,255,0.6)"}}>
                            <span style={{color: "#86efac", fontSize: "10px"}}>✓</span>
                            {f}
                          </div>
                        );
                      })}
        ...
        <div style={{overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.1)"}}>
          <div style={{display: "flex", animation: "marquee 22s linear infinite", width: "max-content", padding: "14px 0"}}>
            {featureTags.map(function(tag, i) {
              return (
                <div key={i} style={{display: "flex", alignItems: "center", gap: "12px", paddingRight: "20px", whiteSpace: "nowrap"}}>
                  <span style={{backgroundColor: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.75)", padding: "5px 14px", borderRadius: "999px", fontSize: "12px", fontWeight: "500"}}>
                    {tag}
                  </span>
              ...
              {plans.map(function(plan, i) {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{display: "inline-block", backgroundColor: "rgba(255,255,255,0.1)", color: "white", border: "1px solid rgba(255,255,255,0.2)", padding: "4px 12px", borderRadius: "999px", fontSize: "11px", fontWeight: "700", marginBottom: "20px"}}>
                      {plan.discount}
                    </div>
