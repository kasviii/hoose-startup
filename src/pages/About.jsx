...
export default function About() {
  return (
    <div style={{backgroundColor: "#0b7d40"}}>
      ...
      {/* Hero */}
      <section style={{position: "relative", background: "linear-gradient(160deg, #085c30 0%, #0b7d40 50%, #0d9651 100%)", overflow: "hidden", padding: "160px 0 100px"}}>
        <div style={{position: "absolute", inset: 0}}>
          <div style={{position: "absolute", width: "600px", height: "600px", borderRadius: "50%", background: "radial-gradient(circle, rgba(255,255,255,0.06) 0%, transparent 70%)", top: "-100px", right: "-100px"}} />
        ...
        <div style={{maxWidth: "900px", margin: "0 auto", padding: "0 48px", textAlign: "center", position: "relative", zIndex: 1}}>
          ...
          >
            <span className="shimmer-text">"Hoose"</span> the guy<br />doing it?
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.3 }}
            style={{fontSize: "18px", color: "rgba(255,255,255,0.8)", lineHeight: "1.8", maxWidth: "600px", margin: "0 auto"}}
          >
      ...
      <section style={{backgroundColor: "#0b7d40", padding: "100px 0"}}>
        <div style={{maxWidth: "1100px", margin: "0 auto", padding: "0 48px"}}>
          ...
          <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "100px"}}>
            ...
            >
              <div style={{position: "absolute", top: "-40px", right: "-40px", width: "180px", height: "180px", borderRadius: "50%", background: "radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)"}} />
              <div style={{fontSize: "40px", marginBottom: "20px"}}>🔭</div>
