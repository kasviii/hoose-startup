  ...
  return (
    <div style={{backgroundColor: "#0b7d40"}}>
      ...
      <section ref={heroRef} style={{position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", background: "linear-gradient(160deg, #085c30 0%, #0b7d40 50%, #0d9651 100%)"}}>
            ...
            <div>
              ...
              <div style={{overflow: "hidden", marginBottom: "24px"}}>
                <motion.h1
                  ...
                  style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "40px" : "62px", fontWeight: "900", lineHeight: "1.06", letterSpacing: isMobile ? "-1px" : "-3px", color: "white", margin: 0}}
                >
                  {"India's first & "}
              ...
              <motion.p
                ...
                style={{fontSize: isMobile ? "16px" : "18px", color: "rgba(255,255,255,0.8)", maxWidth: "460px", lineHeight: "1.85", marginBottom: "40px"}}
              >
              ...
              >
                <motion.div
                  ...
                  style={{backgroundColor: "white", color: "#0b7d40", padding: isMobile ? "13px 28px" : "15px 36px", borderRadius: "999px", fontWeight: "700", fontSize: "15px", cursor: "pointer", fontFamily: "Syne, sans-serif", boxShadow: "0 8px 32px rgba(0,0,0,0.2)"}}
                ...
                <motion.div
                  ...
                  style={{border: "2px solid rgba(255,255,255,0.4)", color: "white", padding: isMobile ? "13px 28px" : "15px 36px", borderRadius: "999px", fontWeight: "500", fontSize: "15px", cursor: "pointer"}}
        ...
        >
          <span>Scroll</span>
          <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 1.5, repeat: Infinity }} style={{width: "1px", height: "40px", background: "linear-gradient(to bottom, rgba(255,255,255,0.4), transparent)"}} />
        </motion.div>
      </section>
        ...
        <div style={{maxWidth: "1280px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px"}}>
          <div style={{display: "grid", gridTemplateColumns: "1fr 1fr 1fr", textAlign: "center"}}>
            {[[50, "+", "Vendors onboarded"], [null, "Mumbai", "Operating city"], [270, "+", "Community network"]].map(function(stat, i) {
              const num = stat[0]; const suffix = stat[1]; const label = stat[2];
              return (
                <motion.div
                  key={label}
      ...
      <section style={{backgroundColor: "#0b7d40", padding: isMobile ? "64px 0" : "100px 0"}}>
        <div style={{maxWidth: "1280px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px"}}>
          <div className="reveal" style={{textAlign: "center", marginBottom: "48px"}}>
            ...
            <h2 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "32px" : "48px", fontWeight: "900", color: "white", letterSpacing: "-1px", marginBottom: "16px"}}>Four steps to success</h2>
            <p style={{fontSize: "16px", color: "rgba(255,255,255,0.7)", maxWidth: "480px", margin: "0 auto", lineHeight: "1.7"}}>Getting started with Hoose is simple. We handle the complexity so you can focus on your food.</p>
          </div>
          <div style={{display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: "16px"}}>
            {process.map(function(step, i) {
              const num = step[0]; const title = step[1]; const desc = step[2];
              return (
                <motion.div
                  key={num}
                  className="reveal"
                  style={{backgroundColor: "rgba(0,0,0,0.18)", borderRadius: "24px", padding: isMobile ? "24px 18px" : "36px 28px", border: "1px solid rgba(255,255,255,0.12)", position: "relative", overflow: "hidden"}}
                  whileHover={{ y: -8, backgroundColor: "rgba(0,0,0,0.28)", borderColor: "rgba(255,255,255,0.25)" }}
                  transition={{ type: "spring", stiffness: 300, damping: 25 }}
                >
                  <div style={{position: "absolute", top: "-10px", right: "12px", fontFamily: "Syne, sans-serif", fontSize: "60px", fontWeight: "900", color: "rgba(255,255,255,0.05)", lineHeight: 1, userSelect: "none"}}>{num}</div>
                  <div style={{width: "40px", height: "40px", borderRadius: "12px", backgroundColor: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "16px"}}>
                    <span style={{fontSize: "18px", fontWeight: "900", color: "white", fontFamily: "Syne, sans-serif"}}>{i + 1}</span>
                  </div>
                  <h3 style={{fontFamily: "Syne, sans-serif", fontSize: "17px", fontWeight: "800", color: "white", marginBottom: "8px"}}>{title}</h3>
      ...
      {/* FEATURES */}
      <section style={{backgroundColor: "rgba(0,0,0,0.25)", padding: isMobile ? "64px 0" : "120px 0", position: "relative", overflow: "hidden"}}>
        ...
        <div style={{maxWidth: "1280px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px", position: "relative", zIndex: 1}}>
          <div className="reveal" style={{textAlign: "center", marginBottom: "48px"}}>
            ...
            <h2 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "32px" : "48px", fontWeight: "900", color: "white", letterSpacing: "-1px"}}>Built for food entrepreneurs</h2>
          </div>
          <div style={{display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: "16px"}}>
            {features.map(function(f, i) {
              return (
                <motion.div
                  key={f[1]}
                  className="reveal"
                  style={{backgroundColor: "rgba(0,0,0,0.18)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "24px", padding: isMobile ? "24px 18px" : "36px 28px"}}
                  whileHover={{ backgroundColor: "rgba(0,0,0,0.3)", borderColor: "rgba(255,255,255,0.25)", y: -6 }}
                  transition={{ type: "spring", stiffness: 300, damping: 25 }}
                >
                  <div style={{fontSize: isMobile ? "32px" : "40px", marginBottom: "16px"}}>{f[0]}</div>
                  <h3 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "15px" : "18px", fontWeight: "700", color: "white", marginBottom: "8px"}}>{f[1]}</h3>
                  <p style={{fontSize: "13px", color: "rgba(255,255,255,0.6)", lineHeight: "1.7"}}>{f[2]}</p>
                </motion.div>
              );
            })}
          </div>
      ...
      {/* REVIEWS */}
      <section style={{backgroundColor: "#0b7d40", padding: isMobile ? "64px 0" : "120px 0", overflow: "hidden"}}>
        <div style={{maxWidth: "1280px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px"}}>
          <div className="reveal" style={{display: "flex", justifyContent: "space-between", alignItems: isMobile ? "flex-start" : "flex-end", flexDirection: isMobile ? "column" : "row", gap: isMobile ? "16px" : "0", marginBottom: "40px"}}>
            <div>
              ...
              <h2 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "30px" : "48px", fontWeight: "900", color: "white", letterSpacing: "-1px", lineHeight: "1.1"}}>Vendors love Hoose</h2>
            </div>
          ...
          <div style={{overflow: "hidden"}}>
            <motion.div
              ...
              animate={{ x: "calc(-" + reviewIndex + " * (" + (isMobile ? "100%" : "33.333%") + " + " + (isMobile ? "0px" : "7px") + "))" }}
            ...
            >
              {reviews.concat(reviews).map(function(r, i) {
                return (
                  <motion.div
                    key={i}
                    style={{backgroundColor: "rgba(0,0,0,0.2)", borderRadius: "24px", padding: isMobile ? "24px" : "36px", border: "1px solid rgba(255,255,255,0.12)", minWidth: isMobile ? "100%" : "calc(33.333% - 14px)", flexShrink: 0}}
                  ...
                  >
                    ...
                    <p style={{fontSize: isMobile ? "14px" : "16px", color: "rgba(255,255,255,0.9)", lineHeight: "1.8", marginBottom: "24px", fontStyle: "italic"}}>"{r.text}"</p>
      ...
      {/* CTA */}
      <section style={{position: "relative", overflow: "hidden", padding: isMobile ? "72px 0" : "120px 0", backgroundColor: "rgba(0,0,0,0.25)"}}>
        <div style={{position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)", backgroundSize: "60px 60px"}} />
        <div className="reveal" style={{maxWidth: "800px", margin: "0 auto", padding: isMobile ? "0 20px" : "0 48px", textAlign: "center", position: "relative", zIndex: 1}}>
          ...
          <h2 style={{fontFamily: "Syne, sans-serif", fontSize: isMobile ? "36px" : "60px", fontWeight: "900", color: "white", marginBottom: "20px", letterSpacing: isMobile ? "-1px" : "-2px", lineHeight: "1.05"}}>
            Ready to grow your<br />
            <span className="shimmer-text">food business?</span>
          </h2>
          <p style={{fontSize: isMobile ? "15px" : "18px", color: "rgba(255,255,255,0.7)", marginBottom: "40px", lineHeight: "1.8"}}>
            Join 50+ vendors already on Hoose and start scaling today.
          </p>
          <div style={{display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap"}}>
            <motion.div
              onClick={function() { navigate("/contact"); }}
              style={{backgroundColor: "white", color: "#0b7d40", padding: isMobile ? "14px 32px" : "16px 48px", borderRadius: "999px", fontWeight: "700", fontSize: isMobile ? "14px" : "16px", cursor: "pointer", fontFamily: "Syne, sans-serif", boxShadow: "0 8px 32px rgba(0,0,0,0.2)"}}
              whileHover={{ scale: 1.05, backgroundColor: "#86efac" }}
              whileTap={{ scale: 0.97 }}
            >
              Join Hoose →
            ...
            <motion.div
              ...
              style={{border: "2px solid rgba(255,255,255,0.4)", color: "white", padding: isMobile ? "14px 32px" : "16px 48px", borderRadius: "999px", fontWeight: "500", fontSize: isMobile ? "14px" : "16px", cursor: "pointer"}}
              whileHover={{ borderColor: "rgba(255,255,255,0.8)", backgroundColor: "rgba(255,255,255,0.1)" }}
              whileTap={{ scale: 0.97 }}
            >
              For Operators
